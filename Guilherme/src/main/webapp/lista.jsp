...
<nav class="navbar navbar-expand-lg navbar-inverse" style="background-color: #5563a391;">
  <div class="container-fluid">
    <a class="navbar-brand" href="./Home.html">Agência de Viagens</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.html">Retornar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="CreateAndFind">Lista de Clientes</a>
        </li>
      </ul>
      <form class = "navbar-form navbar-left" action="CreateAndFind" method="GET" class="d-flex">
