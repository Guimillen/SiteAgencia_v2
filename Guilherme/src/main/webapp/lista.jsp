...
<nav class="navbar navbar-expand-lg navbar-inverse" style="background-color: #5563a391;">
  <div class="container-fluid">
    <a class="navbar-brand" href="./home">Agência de Viagens</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.html">Retornar ao Cadastro</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="CreateAndFind">Relação completa de Clientes</a>
        </li>
      </ul>
